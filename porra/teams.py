...
from porra import players

def get_teams(standings_dict, store=False):
    """Extract teams from standings data and optionally persist team metadata."""
    ...
    return teams
class Team:
    """Represents a team and provides methods for fetching team data."""
    def __init__(self, team_id, name):
        """Initialize the Team instance with its ID and name."""
    ...
    def get_team_seasons(self, store=False):
        """Fetch and optionally persist team season metadata."""
    ...
    def get_team_stats(self, tournament_id, tournament_name, season_id, season_name, season_year, store=False):
        """Fetch and optionally persist team statistics for a season."""
    ...
    def get_team_recent_performance(self, store=False):
        """Fetch and optionally persist the team's recent performance data."""
    ...
    def get_team_last_matches(self, store=False):
        """Fetch and optionally persist the team's last match results."""
    ...
    def get_team_squad(self, store=False):
        """Fetch and optionally persist the team's squad roster and create Player objects."""
    ...
    def get_squad_context(self):
        """Build a squad context using player statistics for the team."""
    ...
    def get_team_context(self, tournament_id, season_id):
        """Assemble a full team context including stats, performance, and squad info."""
