...
class Tournament:
    """Represents a tournament and provides methods to fetch its seasons and stats."""
    def __init__(self, tournament_id, name):
        """Initialize the Tournament instance with its ID and name."""
    ...
    def get_tournament_stats(self, season_id, season_name, season_year, store=False):
        """Fetch and optionally persist tournament statistics for a season."""
