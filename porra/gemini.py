...
from porra import events, teams, players
...
class gemini:
    """Gemini predictor wrapper for World Cup match forecasting."""
    def __init__(self, api_key=None, model=None):
        """Initialize the Gemini predictor wrapper with API credentials."""
    ...
    def build_match_context(self, event_id, team_a_id, team_b_id):
        """Build match context from local JSON and MongoDB data for prediction."""
    ...
    def generate_prediction(self, event_id, team_a_id, team_b_id):
        """Generate a match prediction using Gemini based on constructed context."""
